    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Itens arquivados de todo o sistema • Exclua permanentemente quando não precisar mais
        </p>
      </div>
      ...
      <Card className="p-4 bg-amber-500/10 border-amber-500/30">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-medium text-amber-700 dark:text-amber-400">Sobre itens arquivados</p>
            <p className="text-sm text-muted-foreground mt-1">
              Itens arquivados são mantidos como um filtro antes da exclusão permanente. 
              Você pode restaurá-los a qualquer momento ou excluí-los definitivamente quando não precisar mais. 
              Recomendamos revisar periodicamente itens arquivados há mais de 90 dias.
            </p>
          </div>
        </div>
      </Card>
      ...
      <AlertDialog open={bulkDeleteConfirm} onOpenChange={setBulkDeleteConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2">
              <AlertTriangle className="h-5 w-5 text-destructive" />
              Excluir {selectedItems.size} Itens Permanentemente
            </AlertDialogTitle>
            <AlertDialogDescription>
              Tem certeza que deseja excluir {selectedItems.size} item(ns) permanentemente?
              <br /><br />
              <strong className="text-destructive">Esta ação não pode ser desfeita e todos os dados serão perdidos.</strong>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancelar</AlertDialogCancel>
